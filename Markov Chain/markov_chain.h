 ...
 * @return the MarkovNodeFrequency
 */
 ...
 * @param max_words the maximum number of words to read from the file
...
/**
 * Generate a random tweet from the given markov_chain.
 * @param max_tweets the maximum number of tweets to generate
